...
function registerCommands(context, aiService, diagnosticsProvider) {
    return [
        vscode.commands.registerCommand('ai-code-review.analyze', () => analyzeCode(diagnosticsProvider)),
        vscode.commands.registerCommand('ai-code-review.explain', (diagnostic) => explainIssue(aiService, diagnostic)),
        vscode.commands.registerCommand('ai-code-review.fix', (diagnostic) => fixIssue(aiService, diagnostic)),
        vscode.commands.registerCommand('ai-code-review.optimize', (diagnostic) => optimizeCode(aiService, diagnostic))
    ];
}
